...
pub const Node = union(enum) {
    ...
    fn getMask(self: Self) Tree.Mask {
        return switch (self) {
            ...
            .str_lit,
            .try_expr,
            => Tree.Mask{ .insert_at = false, .remove_at = false, .input_text = true },
            .expr_stmt,
            .fn_proto,
            .param_decl,
            .any_type,
            .fn_decl,
            .const_decl,
            => Tree.Mask{ .insert_at = false, .remove_at = false, .input_text = false },
            .arg_list,
            .op,
            .block,
            .param_list,
            => Tree.Mask{ .insert_at = true, .remove_at = true, .input_text = false },
        };
    }
